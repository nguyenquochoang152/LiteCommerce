...
namespace LiteCommerce.DataLayers.SqlServer
{
    public class ProductDAL : IProductDAL
    {
        ...
        public int Count(string searchValue,string Category,string SuppliSer)
        {
            int count = 0;
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@Supplier", SuppliSer);
        ...
        public List<Product> List(int page, int pageSize, string searchValue, string Category, string SuppliSer)
        {
